                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-3xl mb-10 leading-6 font-bold text-gray-900 text-center">
                                        ¿Eliminar Tarea?
                                    </Dialog.Title>
                                    <p className='text-gray-700 font-black text-center text-xl'>Nombre: <span className='text-xl text-gray-800 uppercase font-bold'>{tarea?.nombre}</span> </p>
